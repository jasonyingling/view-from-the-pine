	...
	if($tags) {
        ...
        if($related_posts) {
        	foreach ($related_posts as $post) : setup_postdata($post); ?>
	           	...
	           	<!-- <li class="related_post"><a class="entry-unrelated" href="<?php the_permalink() ?>" title="<?php the_title_attribute(); ?>"><?php the_post_thumbnail('bones-thumb-300'); ?></a></li> -->
	        <?php endforeach; }
	    else { ?>
            <?php echo '<li class="no_related_post">No Related Posts</li>'; ?>
		<?php }
	}
	wp_reset_query();
	echo '</ul>';
